...
function Nav() {
  return (
    ...
    <ul className=" py-1 space-x-1 px-3 md:text-sm hidden lg:flex lg:space-x-7 md:space-x-4 xl:space-x-10 lg:text-ft3 ">
    ...
    <div className=" py-1 flex space-x-4 md:text-xs lg:text-ft3 ">
    ...
    <button className="px-1 sm:px-2 lg:text-ft3 sm:text-lg text-sm py-1 border-2 rounded-full text-white bg-blue-50  hover:bg-white font-bold focus:ring-4 hover:border-black-100 hover:text-black-100 ">CONNECT WALLET</button></div>
  </nav>
  )
}
