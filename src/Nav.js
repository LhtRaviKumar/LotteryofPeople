...
function Nav() {
  return (
    ...
    <button className="px-4 py-1 border-2 rounded-full text-red hover:text-black-50 font-bold border-red hover:border-black-50">CREATE GAME</button>
    <button className="px-4 py-1 border-2 rounded-full text-white bg-blue-50  hover:bg-white font-bold focus:ring-4 hover:border-black-100 hover:text-black-100 ">CONNECT WALLET</button></div>
  </nav>
  )
}
